      ...
      <div className="navbar-inner">
        <a href="#hero" className="nav-logo">
          <Image
            ...
            alt="SentraLabs — estudio de desarrollo de software"
            width={102}
            height={36}
            priority
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          {/* Enlace, no botón: cada idioma tiene su propia URL indexable. */}
          <Link
            href={lang === "es" ? "/en" : "/"}
    ...
    <section className="hero section" id="hero">
      <div className="container">
        ...
        >
          ...
          <motion.h1 className="hero-tagline" variants={fadeUp} custom={0.5}>
...
/* Cada versión declara su FAQ en su idioma y con el id de su propia URL. */
function buildFaqSchema(lang: Lang) {
  return {
    "@context": "https://schema.org",
    "@type": "FAQPage",
    "@id": lang === "en" ? `${SITE_URL}/en#faq` : `${SITE_URL}/#faq`,
    inLanguage: lang,
...
function FAQ() {
  ...
  return (
    <section className="section" id="faq">
      <JsonLd data={buildFaqSchema(lang)} />
      <div className="container">
        <motion.div
          className="section-header"
          initial={{ opacity: 0, y: 20 }}
...
const projects = [
  ...
  },
  {
    ...
    mockups: [
      "/images/projects/marsec/marsec-app-pantalla-1.webp",
      "/images/projects/marsec/marsec-app-pantalla-2.webp",
      "/images/projects/marsec/marsec-app-pantalla-3.webp",
    ],
  },
  {
    image: "",
    ...
    mockups: [
      "/images/projects/ecoone/ecoone-app-pantalla-1.webp",
      "/images/projects/ecoone/ecoone-app-pantalla-2.webp",
      "/images/projects/ecoone/ecoone-app-pantalla-3.webp",
    ],
  },
];
        ...
        <div className="lightbox-overlay" onClick={() => setLightbox(null)}>
          ...
          <div className="lightbox-phone" onClick={(e) => e.stopPropagation()}>
            <div className="lightbox-screen">
              <Image src={lightbox} alt="Captura ampliada de la aplicación" fill style={{ objectFit: "cover" }} />
            </div>
          </div>
        </div>
      )}
              ...
              >
                <div className="project-icon">
                  {p.image ? (
                    <Image
                      src={p.image}
                      alt={`Logo de ${p.name}, proyecto de SentraLabs`}
                      width={48}
                      height={48}
                      ...
                      {((p as { mockups?: string[] }).mockups ?? []).map((src, idx) => (
                        <div className="phone-mockup" key={idx} onClick={() => setLightbox(src)} style={{ cursor: "pointer" }}>
                          <div className="phone-screen">
                            <Image
                              src={src}
                              alt={`Pantalla ${idx + 1} de la app ${p.name} desarrollada por SentraLabs`}
                              fill
            ...
            >
              <Link href={`/team/${m.slug}`} style={{ textDecoration: "none", color: "inherit" }}>
                <div className="team-avatar">
                  <Image
                    src={m.image}
                    alt={`${m.name}, ${m.role} en SentraLabs`}
                    width={80}
                    height={80}
...
/* ────────────────── Page ────────────────── */
/* La misma home para los dos idiomas; quien la renderiza (app/page.tsx o
